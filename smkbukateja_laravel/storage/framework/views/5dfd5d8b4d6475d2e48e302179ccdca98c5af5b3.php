...
<body style="background-color:#EEEEEE">
	...
	<div class="container">
		<div class="row">
			<?php $__currentLoopData = $informasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<div class="col-sm-4 mb-3">
				<div class="card">
					<a href="<?php echo e(route('informasi.baca', $i->slug)); ?>" style="text-decoration: none; color: #B7292D;">
						<img src="<?php echo e(url('img/artikel'.'/' . $i->gambar)); ?>" class="card-img-top" alt="">
						<div class="card-body">
							<h5 class="card-title">
								<?php echo e($i->judul); ?>
...
<?php /**PATH E:\Ripki Alfinnur\TUGAS PRIBADI\SEMESTER 5\Gracia_SE03A_DPW\smkbukateja_laravel\resources\views/informasi.blade.php ENDPATH**/ ?>