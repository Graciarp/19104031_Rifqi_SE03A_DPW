<footer>
    ...
    <div class="d-flex justify-content-center text-white" style="background-color: #B7292D;">
        <div class="p-2">Copyright © <?php echo e(date('Y')); ?> SMKN 1 BUKATEJA | Powered by Team Romusha</div>
    </div>
    <!-- Copyright -->
</footer>
<?php /**PATH E:\Ripki Alfinnur\TUGAS PRIBADI\SEMESTER 5\Gracia_SE03A_DPW\smkbukateja_laravel\resources\views/footer.blade.php ENDPATH**/ ?>