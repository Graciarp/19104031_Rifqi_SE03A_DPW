...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">{{ __('Edit Data Prestasi') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('prestasi.update', $prestasi->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="judul" value="{{$prestasi->judul}}" type="text" class="form-control @error('judul') is-invalid @enderror" name="judul" value="{{ old('judul') }}" required autocomplete="judul" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">     
                                <textarea required name="isi" class="form-control" rows="5">{{$prestasi->isi}}</textarea>
                            </div>
                        </div>
