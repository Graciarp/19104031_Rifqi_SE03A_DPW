...
<head>
    ...
    <title>Program Keahlian - Teknik Body Otomotif</title>
...
<body>
    ...
    <div class="container-fluid p-0">
        <div class="banner-prodi">
            ...
            <img class="img-prodi"
                src="/img_jurusan/Jurusan/TBO/Banner/Banner TBO.jpg"
                alt="">

            <div class="prodi-title">
                <h3>Program Keahlian</h3>
                <p>Teknik Body Otomotif</p>
            </div>
        </div>
    </div>
    <br><br><br><br>
    ...
    <div class="container section-sejarah">
        ...
        <img src="/img_jurusan/Jurusan/TBO/(Fake) Logo.jpg" align="left" style="margin-left: 40px; margin-right: 40px; margin-bottom: 40px; width: 250px;">
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-12 col-sm-12 mb-5">
                <div class="ui-card">
                    <img id="image" src="/img_jurusan/Jurusan/TBO/Keterampilan 1.jpg">
                    <div class="desc">
                        <h5><strong>Lorem ipsum dolor sit.</strong></h5>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 mb-5">
                <div class="ui-card">
                    <img id="image" src="/img_jurusan/Jurusan/TBO/Keterampilan 2.jpg">
                    <div class="desc">
                        <h5><strong>Lorem ipsum dolor sit.</strong></h5>
                        <p>Lorem ipsum dolor sit amet consectetur. orem ipsum dolor sit amet consectetur. orem ipsum
                            dolor sit amet consectetur.</p>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 mb-5">
                <div class="ui-card">
                    <img id="image" src="/img_jurusan/Jurusan/TBO/Keterampilan 3.jpg">
                    <div class="desc">
                        <h5><strong>Lorem ipsum dolor sit.</strong></h5>
                        <p>Lorem ipsum dolor sit amet consectetur. orem ipsum dolor sit amet consectetur. orem ipsum
                            dolor sit amet consectetur.</p>
    ...
    <div class="container mb-5">
        <div class="js-carousel owl-carousel owl-theme">
            <div class="ms-2 me-2">
                <div class="card">
                    <img src="/img_jurusan/Jurusan/TBO/Galery Kegiatan/Kegiatan 1.jpg" class="card-img-top">
                </div>
            </div>

            <div class="ms-2 me-2">
                <div class="card">
                    <img src="/img_jurusan/Jurusan/TBO/Galery Kegiatan/Kegiatan 2.jpg" class="card-img-top">
                </div>
            </div>

            <div class="ms-2 me-2">
                <div class="card">
                    <img src="/img_jurusan/Jurusan/TBO/Galery Kegiatan/Kegiatan 3.jpg" class="card-img-top">
                </div>
            </div>

            <div class="ms-2 me-2">
                <div class="card">
                    <img src="img/Jurusan/TBO/Galery Kegiatan/Kegiatan 4.jpg" class="card-img-top">
                </div>
            </div>

            <div class="ms-2 me-2">
                <div class="card">
                    <img src="img/Jurusan/TBO/Galery Kegiatan/Kegiatan 5.jpg" class="card-img-top">
                </div>
            </div>
        </div>
    </div>
