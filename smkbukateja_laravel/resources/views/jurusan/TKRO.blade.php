...
<head>
    ...
    <title>Program Keahlian - Teknik Kendaraan Ringan Dan Otomotif</title>
...
<body>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="program-Keahlian dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="DPIB.html">Desain Permodelan Bangunan</a></li>
                            <li><a class="dropdown-item" href="TB.html">Tata Busana</a></li>
                            <li><a class="dropdown-item" href="TKRO.html">TKR</a></li>
                            <li><a class="dropdown-item" href="TKJ.html">TKJ</a></li>
                            <li><a class="dropdown-item" href="Multimedia.html">Multimedia</a></li>
                            <li><a class="dropdown-item" href="RPL.html">RPL</a></li>
                            <li><a class="dropdown-item" href="TBO.html">Teknik Body Otomotif</a></li>
                        </ul>
                    </li>
                    <li class="guru-karyawan"><a href="">Guru dan Karyawan</a></li>
                    <li class="prestasi"><a href="/prestasi.html">Prestasi</a></li>
                    <!-- dropdown navbar -->
                    <li class="informasi dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="/informasi.html">Berita</a></li>
    ...
    <div class="container-fluid p-0">
        <div class="banner-prodi">
            ...
            <img class="img-prodi"
                src="/img_jurusan/Jurusan/TKRO/Banner/Banner TKRO.jpg"
                alt="">
    ...
    <div class="container section-sejarah">
        ...
        <img src="/img_jurusan/Jurusan/TKRO/TKRO Logo.jpeg" align="left" style="margin-left: 40px; margin-right: 40px; margin-bottom: 40px; width: 250px;">

        <div class="text-justify">
            <p> Teknik Kendaraan Ringan Otomotif merupakan jurusan ke Tiga yang ada di SMK N 1 Bukateja
            </p>

            <p> Teknik Kendaraan Ringan Otomotif menampung  siswa yang berminat di bidang otomotif khususnya kendaraan ringan
            </p>
    ...
    <!--------------- Dasar Keterampilan Start --------------->

    <div class="container mt-5">
        <h3 class="judul-logo-satu mb-5">Dasar Keterampilan</h3>
        <div class="row">
            <div class="col-lg-4 col-md-12 col-sm-12 mb-5">
                <div class="ui-card">
                    <img id="image" src="/img_jurusan/Jurusan/TKRO/Keterampilan 1.jpg">
                    <div class="desc">
                        <h5><strong>Pemeliharaan Mesin Kendaraan Ringan</strong></h5>
                        <p>Siswa mahir dalam menganalisa dan memperbaiki kerusakan pada mesin kendaraan ringan baik konfensional maupun injeksi.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 mb-5">
                <div class="ui-card">
                    <img id="image" src="/img_jurusan/Jurusan/TKRO/Keterampilan 2.jpg">
                    <div class="desc">
                        <h5><strong>Pemeliharaan Sasis Dan Pemindah Tenaga Kendaraan Ringan</strong></h5>
                        <p>Siswa mahir dalam menganalisa dan memperbaiki kerusakan pada sistem sasis dan pemindah tenaga kendaraan ringan baik manual maupun otomatis</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 mb-5">
                <div class="ui-card">
                    <img id="image" src="/img_jurusan/Jurusan/TKRO/Keterampilan 3.jpg">
                    <div class="desc">
                        <h5><strong>Pemeliharaan Kelistrikan Kendaraan Ringan</strong></h5>
                        <p>Siswa mahir dalam menganalisa dan memperbaiki kerusakan pada sistem kelistrikan kendraan ringan </p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!--------------- Dasar Keterampilan End --------------->


    <!--------------- Prospek Kerja Start --------------->

    <div class="container mt-5">
        <h3 class="judul-logo-satu mb-5">Prospek Kerja</h3>
    ...
    <h3 class="judul-logo-dua mb-5">Galeri Kegiatan</h3>

    <div class="container mb-5">
        <div class="js-carousel owl-carousel owl-theme">
            <div class="ms-2 me-2">
                <div class="card">
                    <img src="/img_jurusan/Jurusan/TKRO/Galery Kegiatan/Kegiatan 1.jpg" class="card-img-top">
                </div>
            </div>

            <div class="ms-2 me-2">
                <div class="card">
                    <img src="/img_jurusan/Jurusan/TKRO/Galery Kegiatan/Kegiatan 2.jpg" class="card-img-top">
                </div>
            </div>

            <div class="ms-2 me-2">
                <div class="card">
                    <img src="/img_jurusan/Jurusan/TKRO/Galery Kegiatan/Kegiatan 3.jpg" class="card-img-top">
                </div>
            </div>

            <div class="ms-2 me-2">
                <div class="card">
                    <img src="/img_jurusan/Jurusan/TKRO/Galery Kegiatan/Kegiatan 4.jpg" class="card-img-top">
                </div>
            </div>

            <div class="ms-2 me-2">
                <div class="card">
                    <img src="/img_jurusan/Jurusan/TKRO/Galery Kegiatan/Kegiatan 5.jpg" class="card-img-top">
                </div>
            </div>
        </div>
    </div>
